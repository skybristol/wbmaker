...
class Item():
    def __init__(self, data: dict, wb=None, commit=False, summary=None):
        ...
        if 'aliases' in data and data['aliases']:
            ...
            self.item.aliases.set('en', data['aliases'], action_if_exists=self.wb.wbi_enums.ActionIfExists.REPLACE_ALL)
